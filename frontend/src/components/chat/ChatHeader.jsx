...
export default function ChatHeader({ order, otherUser, otherUserProfilePicture }) {
  ...
  return (
    <div className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
      ...
      <div className="w-10 h-10 gradient-bg rounded-xl flex items-center justify-center text-white text-sm font-bold flex-shrink-0 overflow-hidden">
