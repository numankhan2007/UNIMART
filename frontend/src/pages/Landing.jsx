...
function ProductCollage() {
  return (
    <div className="relative w-full max-w-lg mx-auto" style={{ height: 380 }}>
      {/* Background glow */}
      <div className="absolute inset-0 rounded-full bg-primary-100/40 dark:bg-primary-900/20 blur-3xl" style={{ transform: 'scale(0.7)' }} />
      ...
      >
        <div className="w-full h-28 bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 rounded-xl flex items-center justify-center text-4xl mb-3">
          📚
        </div>
        <p className="text-sm font-semibold text-gray-900 dark:text-white">Engineering Textbook</p>
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">3rd Semester</p>
        <div className="mt-2 inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400">
          ₹250
        </div>
      </div>
      ...
      {/* Card 2 — Electronics */}
      <div
        className="absolute glass-card p-4 w-48"
        style={{
          top: '25%', right: '0%',
          animation: 'lnd-float 6s ease-in-out infinite',
          animationDelay: '1s',
      ...
      >
        <div className="w-full h-24 bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl flex items-center justify-center text-4xl mb-3">
          💻
        </div>
        <p className="text-sm font-semibold text-gray-900 dark:text-white">Scientific Calculator</p>
        <div className="mt-2 inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400">
          Free
        </div>
      </div>
      ...
      <div
        className="absolute glass-card p-4 w-44"
        style={{
          bottom: '5%', left: '15%',
          animation: 'lnd-float 6s ease-in-out infinite',
          animationDelay: '2s',
      ...
      >
        <div className="w-full h-20 bg-gradient-to-br from-amber-50 to-amber-100 dark:from-amber-900/20 dark:to-amber-800/20 rounded-xl flex items-center justify-center text-3xl mb-3">
          🔬
        </div>
        <p className="text-sm font-semibold text-gray-900 dark:text-white">Lab Kit</p>
        <div className="mt-2 inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold bg-primary-50 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400">
          ₹180
        </div>
      </div>
      ...
      >
        ...
        <span className="text-xs font-semibold text-gray-700 dark:text-gray-200">Verified Seller</span>
      </div>
    </div>
  );
}
    ...
    <div className="min-h-screen" style={{ background: '#f8f9ff' }}>
        ...
        <div className="relative section-padding pt-32 sm:pt-40 pb-16 lg:pb-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left" style={{ animation: 'lnd-fade-up 0.6s cubic-bezier(0.16, 1, 0.3, 1) both' }}>
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-primary-50 dark:bg-primary-900/20 border border-primary-100 dark:border-primary-800/30 rounded-full text-sm font-medium text-primary-700 dark:text-primary-300 mb-6">
                <ShieldCheck size={15} />
                Student-Only Marketplace
              </div>

              <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-gray-900 dark:text-white leading-[1.1] tracking-tight">
                The Campus Marketplace{" "}
                <span className="gradient-text">Built on Trust</span>
              </h1>

              <p className="text-lg text-gray-500 dark:text-gray-400 mt-6 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              ...
              <div className="flex flex-wrap gap-3 mt-8 justify-center lg:justify-start">
                ...
                <button
                  ...
                  className="btn-secondary !py-3 !px-7 !rounded-full text-base"
                >
                  How It Works
                </button>
              </div>
              ...
              <div className="flex flex-wrap gap-2 mt-8 justify-center lg:justify-start" style={{ animation: 'lnd-fade-up 0.6s cubic-bezier(0.16, 1, 0.3, 1) 0.3s both' }}>
                {TRUST_BADGES.map((badge, i) => (
                  <span
                    key={i}
                    className="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-white/80 dark:bg-white/5 border border-gray-200/60 dark:border-white/10 text-gray-600 dark:text-gray-300 backdrop-blur-sm"
                  >
                    {badge}
                  </span>
                ))}
      ...
      <section id="trust-section" className="section-padding py-20 lg:py-28">
        <div className="text-center max-w-2xl mx-auto mb-14" style={{ animation: 'lnd-fade-up 0.6s cubic-bezier(0.16, 1, 0.3, 1) both' }}>
          <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider bg-primary-50 dark:bg-primary-900/20 text-primary-600 dark:text-primary-400 mb-4">
            Trust & Safety
          </span>
      ...
      <section className="section-padding pb-16">
        ...
        >
          <h3 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white tracking-tight mb-3">
            ...
            <div className="flex gap-2.5 flex-wrap justify-center">
              {SOCIAL_LINKS.map(({ label, href, icon }, i) => (
                <a
                  ...
                  title={label}
                  className="w-10 h-10 rounded-xl bg-white dark:bg-white/5 border border-gray-200/60 dark:border-white/10 flex items-center justify-center text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 hover:border-primary-200 dark:hover:border-primary-800/50 transition-all duration-200 hover:scale-105"
